...
# Example usage:
# mohir = MohirAi(api_key="your_api_key_here")
# mohir.tts(text="Assalom aleykum! Mening ismim Oyniso. Sizga qanday yordam berishim mumkin?", model="dilfuza", mood="happy", filename="output_audio")
